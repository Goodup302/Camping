...
public class User {
    ...
    public User(String cnom, String cprenom, String cnumTel, String cnumFix,
    ...
    public User setNumTel(String numTel) {
        this.numTel = numTel;
        return this;
    }

    public User setNumFix(String numFix) {
        this.numFix = numFix;
        return this;
    }
    ...
    public User setAdresse(String adresse) {
        this.adresse = adresse;
        return this;
    }

    public User setDateNaissance(Date dateNaissance) {
        this.dateNaissance = dateNaissance;
        return this;
    }

    public User setCivilite(String civilite) {
